...
def get_league_info(espn_s2, swid, team_id, league_id, year):
    ...
    except: # added this in case the API ever fails
        cleaned_df = pd.read_csv("data/data.csv")
        team_name = 'Coby "Bryant" White'
        team_logo = "https://a.espncdn.com/combiner/i?img=/i/headshots/nba/players/full/4395651.png&w=350&h=254"
        return cleaned_df, team_name, team_logo
